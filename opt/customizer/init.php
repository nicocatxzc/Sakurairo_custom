...
$panels = [
	[
        'id'          => 'iro_global',
        'title'       => esc_html__( 'Global Options', 'sakurairo' ),
		'priority'    => 10,
    ],
	[
        'id'          => 'iro_cover',
        'title'       => esc_html__( 'Homepage Cover', 'sakurairo' ),
		'priority'    => 10,
    ],
    [
        'id'          => 'iro_homepage',
        'title'       => esc_html__( 'Homepage Components', 'sakurairo' ),
		'priority'    => 10,
    ],
	[
        'id'          => 'iro_pages',
        'title'       => esc_html__( 'Pages Options', 'sakurairo' ),
		'priority'    => 10,
    ],
];
